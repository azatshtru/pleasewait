<script>
    ...
    const invaliedEmailMessage = "That doesn't seem like a valid email address :(";
    const emailSubmittedMessage = "Thank you! <3 We are excited to show you the future. You'll recieve an email as soon as we're done building it. ";
    ...
    function promptSubmit () {
        ...
        if(!verifyEmail(promptText)){
            sendMessage(invaliedEmailMessage, 3000);
            messageTimeout = setTimeout(() => {messageTimeout = null;}, invaliedEmailMessage.length * 25);
            return;
        }
...
<p class="text">we are building a future where you own and control your <span style="color:blueviolet; font-weight: bold">data and money</span></p>
<br>
<div class="textbox">
